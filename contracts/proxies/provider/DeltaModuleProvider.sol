...
* external contract.
* Based on https://github.com/mudgen/diamond-3-hardhat
/******************************************************************************/

import {IModuleProvider} from "./IModuleProvider.sol";

// solhint-disable max-line-length

contract DeltaModuleProvider is IModuleProvider {
    ...
    function validateModules(address[] memory modules) external view {
        ...
        for (uint256 i; i < length; ) {
            require(_moduleExists[modules[i]], "DeltaModuleProvider: Invalid module");
            unchecked {
                ++i;
            }
        }
