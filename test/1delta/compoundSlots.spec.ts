...
import { CompoundSlotFactory, CompoundSlotFactory__factory, CompoundSlot__factory, ERC20Mock__factory, MinimalSwapRouter, MinimalSwapRouter__factory } from '../../types';
...
describe('Compound Slot Trading', async () => {
    ...
    before('get wallets and fixture', async () => {
        ...
        minimalRouter = await new MinimalSwapRouter__factory(deployer).deploy(uniswap.factory.address, uniswap.weth9.address)
