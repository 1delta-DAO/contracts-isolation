...
import { Slot__factory, ERC20Mock__factory, OVixLensZK__factory, OVixLensZK, SlotFactory, SlotFactory__factory } from '../../../types';
...
describe('Compact Slot Trading', async () => {
    ...
    let compoundSlotFactory: SlotFactory
    ...
    before('get wallets and fixture', async () => {
        ...
        compoundSlotFactory = await new SlotFactory__factory(deployer).deploy(
