...
import { produceSig } from '../test/1delta/shared/permitUtils';
import {  ERC20Mock__factory, FiatWithPermit__factory, OneDeltaSlotFactory__factory } from '../types';
...
async function main() {
    ...
    const factory = await new OneDeltaSlotFactory__factory(operator).attach(coreAddresses.factory[chainId])
