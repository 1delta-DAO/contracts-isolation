...
import { EntryPoint__factory, AaveSlotLens__factory, OneDeltaSlotFactory__factory } from '../types';
...
async function main() {
    ...
    console.log('Factory')
    const factory = await new OneDeltaSlotFactory__factory(operator).deploy(_entryPointAddress, aavePool, router)
